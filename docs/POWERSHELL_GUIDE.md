...
python scripts/data_preprocessing/batch_parse.py --input-dir "C:\path\to\filings"

# Parse with custom file pattern
python scripts/data_preprocessing/batch_parse.py --pattern "AAPL*.html"
...
python scripts/data_preprocessing/batch_parse.py --form-type 10-Q --overwrite

# Process from downloads folder
python scripts/data_preprocessing/batch_parse.py --input-dir "C:\Users\bichn\Downloads\SEC_Filings"
```
...
**Location:** `scripts/data_preprocessing/run_preprocessing_pipeline.py`
...
python scripts/data_preprocessing/run_preprocessing_pipeline.py --no-save
```
...
python scripts/data_preprocessing/run_preprocessing_pipeline.py --input data/raw/AAPL_10K_2023.html
...
python scripts/data_preprocessing/batch_parse.py --pattern "MSFT*.html"
...
foreach ($pattern in $patterns) {
    ...
    python scripts/data_preprocessing/batch_parse.py --pattern $pattern
}
```
...
python scripts/data_preprocessing/batch_parse.py | Tee-Object -FilePath "logs\parse_$(Get-Date -Format 'yyyyMMdd_HHmmss').log"

# Save both stdout and stderr
python scripts/data_preprocessing/batch_parse.py *>&1 | Tee-Object -FilePath "logs\parse.log"
```

**Timestamp logs:**
```powershell
$timestamp = Get-Date -Format "yyyyMMdd_HHmmss"
python scripts/data_preprocessing/batch_parse.py | Out-File "logs\batch_parse_$timestamp.log"
```
...
Get-ChildItem "data\raw\*.html" | ForEach-Object {
    ...
    python scripts/data_preprocessing/run_preprocessing_pipeline.py --input $_.FullName
}
```
...
foreach ($file in $files) {
    ...
    python scripts/data_preprocessing/run_preprocessing_pipeline.py --input $file.FullName
...
python scripts/data_preprocessing/batch_parse.py --input-dir "C:\Users\bichn\MSBA\SEC finetune\data\raw"

# Or use PowerShell variables
$dataPath = "C:\Users\bichn\MSBA\SEC finetune\data\raw"
python scripts/data_preprocessing/batch_parse.py --input-dir $dataPath
```
...
```powershell
# Script help
python scripts/data_preprocessing/batch_parse.py --help
python scripts/utils/inspection/inspect_parsed.py --help
python scripts/data_preprocessing/run_preprocessing_pipeline.py --help
